    ...
    function Pre() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Pre.__proto__ || Object.getPrototypeOf(Pre)).call.apply(_ref, [this].concat(args))), _this), _this.parseJS = function (obj) {
        ...
        switch (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) {
          case 'object':
            if (obj === null) return React.createElement(
              'span',
              { style: nullStyle },
              'null'
            );
            ...
            if (Array.isArray(obj)) {
              return _this.parseArray(obj, level, { inArray: inArray });
            }
            ...
            if (immutableMapKeys.every(function (x) {
              ...
              var _visibleKeys = objKeys.filter(function (x) {
              ...
              return React.createElement(
                ...
                _visibleKeys.map(function (x, i) {
                  return React.createElement(
                    ...
                    '\n',
                    _size > 0 && i === _visibleKeys.length - 1 ? React.createElement(
                      'div',
                      { style: floats },
                      ', entries: ',
                      _this.parseJS(obj._root.entries, level, { isImmutableMap: true })
                    ) : null,
                    i === _visibleKeys.length - 1 ? React.createElement(
                      'div',
                      { style: floats },
                      '}'
                    ) : ''
            ...
            return objKeys.length === 0 ? React.createElement(
              'span',

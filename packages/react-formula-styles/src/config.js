...
export const libName = '@tixinc/react-formula-styles'
export const noop = () => {}
...
export const log =/* !IS_DEV && IS_BROWSER ?*/ ({ name: libName, trace: noop, debug: noop, info: noop, warn: noop, error: noop, fatal: noop }) /*: createLogger({ name, level: 'info' })*/
